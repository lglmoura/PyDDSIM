...
class TradingManager(object):
    ...
    def creatTradingService(self,service,periodStart,periodEnd,quantity,type,snow):
        
        
        trading = TradingService(snow,service,periodStart,periodEnd,quantity,type)
        
        #TradingLogger().resgiterLoggingInfo("randig = URN = ,Peer = %s "%(self.__peer.getPID()))
    ...
    def setServiceForTrading(self,trading):
        ...
        print "****** Final Trading ,Peer = %s = %s"%(self.__peer.getPID(),tranding.getSNow())
